...
if(file_exists(APPLICATION_PATH . '/config/app.ini')){
	...
	$frontController->registerPlugin(new AuthentificationPlugin());
} else {
	$frontController->registerPlugin(new EnterSetupPlugin());
}
